...
define void @func_gather_M_1_0(i64 %lo, i64 %hi, i64 %myId, i1 %ordered, i64 %start, i32* noalias %arg0, double* noalias %arg1, double* noalias %arg2, double* noalias %arg3) {
entrypoint:
...
L5:                                               ; preds = %L5, %L2
  ...
  %84 = fsub double %39, %75
  %85 = fsub double %37, %73
  %86 = fsub double %43, %79
  %87 = fsub double %41, %77
  %88 = fsub double %47, %83
  %89 = fsub double %45, %81
  %90 = fadd double %51, %63
  %91 = fadd double %49, %61
  %92 = fadd double %55, %67
  %93 = fadd double %53, %65
  %94 = fadd double %59, %71
  %95 = fadd double %57, %69
  %96 = mul i64 %7, 18
  %97 = or i64 %96, 1
  %98 = add i64 %96, 2
  %99 = add i64 %96, 3
