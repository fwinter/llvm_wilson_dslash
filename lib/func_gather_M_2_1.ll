...
define void @func_gather_M_2_1(i64 %lo, i64 %hi, i64 %myId, i1 %ordered, i64 %start, i32* noalias %arg0, double* noalias %arg1, double* noalias %arg2, double* noalias %arg3) {
entrypoint:
