...
define void @func_gather_M_3_0(i64 %lo, i64 %hi, i64 %myId, i1 %ordered, i64 %start, i32* noalias %arg0, double* noalias %arg1, double* noalias %arg2, double* noalias %arg3) {
entrypoint:
...
L5:                                               ; preds = %L5, %L2
  ...
  %84 = fadd double %39, %63
  %85 = fadd double %37, %61
  %86 = fadd double %43, %67
  %87 = fadd double %41, %65
  %88 = fadd double %47, %71
  %89 = fadd double %45, %69
  %90 = fadd double %51, %75
  %91 = fadd double %49, %73
  %92 = fadd double %55, %79
  %93 = fadd double %53, %77
  %94 = fadd double %59, %83
  %95 = fadd double %57, %81
  %96 = mul i64 %7, 18
  %97 = or i64 %96, 1
  %98 = add i64 %96, 2
  %99 = add i64 %96, 3
