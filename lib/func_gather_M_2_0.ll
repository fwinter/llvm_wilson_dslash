...
define void @func_gather_M_2_0(i64 %lo, i64 %hi, i64 %myId, i1 %ordered, i64 %start, i32* noalias %arg0, double* noalias %arg1, double* noalias %arg2, double* noalias %arg3) {
entrypoint:
...
L5:                                               ; preds = %L5, %L2
  ...
  %84 = fsub double 0.000000e+00, %63
  %85 = fsub double 0.000000e+00, %67
  %86 = fsub double 0.000000e+00, %71
  %87 = fadd double %39, %61
  %88 = fadd double %37, %84
  %89 = fadd double %43, %65
  %90 = fadd double %41, %85
  %91 = fadd double %47, %69
  %92 = fadd double %45, %86
  %93 = fsub double 0.000000e+00, %75
  %94 = fsub double 0.000000e+00, %79
  %95 = fsub double 0.000000e+00, %83
  %96 = fsub double %51, %73
  %97 = fsub double %49, %93
  %98 = fsub double %55, %77
  %99 = fsub double %53, %94
  %100 = fsub double %59, %81
